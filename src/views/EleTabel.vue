<template>
  ...
  <div class="flex">
    <span class="flex-grow bg-slate-200">1</span>
    <span class="bg-slate-500">1</span>
  </div>
  <h1 class="m-20 text-center text-yellow-200">tailwind css</h1>
  <div
    class="flex mx-auto my-20 border"
    :style="{
      width: '576px',
      height: '256px'
    }"
  >
    <div class="flex-none w-48 relative">
      <img
        src="../assets/classic-utility-jacket.0f108046e151c8576017eaf383406fe6.jpg"
        alt=""
  ...
  <div
    class="w-40 h-96 relative bg-red-50 mx-auto overflow-y-scroll"
    @scroll="isChange"
  >
    {{ arr.length }}
    <div
    ...
    >
      <div
        class="h-9 absolute left-0 border-b w-full"
        :style="{
          top: item * 38 + 'px'
        }"
...
const toggleC = (): void => {
  ...
  const tempVlaue: string | null = window
    .getComputedStyle(document.documentElement)
    .getPropertyValue('--my-color1')
...
const toLog = <T extends DoubleInfo>(a: {
...
false &&
  ElMessageBox.confirm('是否确认?', 'Warning', {
...
.container {
  ...
  grid-template-columns:
    [c1] 100px [c2] minmax(100px, 200px) [c3] minmax(10px, 200px)
    [c4] minmax(10px, 200px) [c5];
